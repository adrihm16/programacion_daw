...
//					}
			...
			case 4:
				...
				System.out.println("Introduce el codigo del articulo que quieres actualizar");
				String codigo = scan.nextLine();
				Articulo art = alm.obtenerArticulo(codigo);
				if (null!=art) {
					System.out.println("Introduce el nuevo pvp");
					String pvpString = scan.nextLine();
					try {
						double pvp = Double.parseDouble(pvpString);
						alm.actualizaPvpProducto(codigo, pvp);
					} catch (NumberFormatException e) {
						System.err.println("Formato de pvp erróneo.");
					}
