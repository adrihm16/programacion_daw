...
public class Almacen {
	...
	public boolean actualizaProducto(Articulo prod) {
	...
	public boolean actualizaPvpProducto(String codigo, Double pvp) {
		Articulo aux = this.articuloDao.obtener(codigo);
		boolean modificado = false;
		if (null != aux) {
			this.articuloDao.actualizarPvp(codigo, pvp);
			modificado = true;
		} else {
			modificado = false;
		}
...
//			}
	...
	public Articulo obtenerArticulo (String codigo){
		return this.articuloDao.obtener(codigo);
	}
